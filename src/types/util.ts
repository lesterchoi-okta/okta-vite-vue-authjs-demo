...
/**
 * Utility type to require only K props of T, all others will be optional
 */
export type PartialRequire<T extends Record<K, unknown>, K extends keyof T> = Partial<T> & {
  [P in K]-?: T[P];
};
